...
<button id="pwa-install-btn" style="display:none; position: fixed; bottom: 20px; right: 20px; padding: 10px 20px; background-color: #007bff; color: white; border: none; border-radius: 8px; z-index: 1000;">
   Install App
    ...
    <!-- small box -->
    <div class="dashboard small-box bg-teal "  style="border-radius: 60px;">
      ...
      @can('index', \App\Models\Asset::class)
        <a href="{{ route('hardware.index') }}" class="small-box-footer"  style="border-radius: 40px;">{{ trans('general.view_all') }}
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <!-- small box -->
    <div class="dashboard small-box bg-maroon" style="border-radius: 20px;">
      <div class="inner">
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="dashboard small-box bg-orange" style="border-radius: 20px;">
      <div class="inner">
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="dashboard small-box bg-purple" style="border-radius: 20px;">
      <div class="inner">
  ...
  <div class="col-lg-2 col-xs-6">
   ...
   <!-- small box -->
   <div class="dashboard small-box bg-yellow" style="border-radius: 20px;">
     <div class="inner">
 ...
 <div class="col-lg-2 col-xs-6">
   ...
   <!-- small box -->
   <div class="dashboard small-box bg-light-blue" style="border-radius: 20px;">
     <div class="inner">
